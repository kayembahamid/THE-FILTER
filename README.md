...
covering direct injection, narrative jailbreaks, indirect injection, and the
precision-versus-recall tension every real filter lives with.

The full course (7 units, all mapped to the OWASP LLM Top 10 for Applications
2025) is available at the link on the completion screen.
